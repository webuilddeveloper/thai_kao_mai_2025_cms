...
@Component({
  selector: 'app-party-members-criteria',
  templateUrl: './party-members-criteria.component.html',
  styleUrls: ['./party-members-criteria.component.css']
})
export class PartyMembersCriteriaComponent implements OnInit {
