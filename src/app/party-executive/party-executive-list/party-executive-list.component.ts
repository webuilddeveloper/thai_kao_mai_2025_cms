...
@Component({
  selector: 'app-party-executive-list',
  templateUrl: './party-executive-list.component.html',
  styleUrls: ['./party-executive-list.component.css']
})
export class PartyExecutiveListComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('partyExecutivePage') != null) {
      let model: any = [];
      this.permission = JSON.parse(localStorage.getItem('partyExecutivePage'));
  ...
  delete(param, idx) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (result) {
        this.serviceProviderService.post('partyExecutive/delete', { code: param.code }).subscribe(data => {
  ...
  reOrder() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (result) {
        ...
        this.serviceProviderService.post('partyExecutive/reorder', { code: model }).subscribe(data => {
  ...
  reOrderAll() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (result) {
        this.serviceProviderService.post('partyExecutive/reorderAll', { code: model }).subscribe(data => {
          this.toastr.success('Re Order เรียบร้อย', 'แจ้งเตือนระบบ', { timeOut: 2000 });
          setTimeout(() => {
            window.location.reload()
          }, 2000)
  ...
  deleteAll() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (result) {
        ...
        this.serviceProviderService.post('partyExecutive/delete', { code: model }).subscribe(data => {
          this.toastr.success('ลบรายการเรียบร้อย', 'แจ้งเตือนระบบ', { timeOut: 2000 });
          setTimeout(() => {
            window.location.reload()
          }, 2000)
  ...
  exportAsXLSX(): void {
    ...
    this.serviceProviderService.post('partyExecutive/report/read', obj).subscribe(data => {
      let model: any = {};
      let result: any = [];
      model = data;
