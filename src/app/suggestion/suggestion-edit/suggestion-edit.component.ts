...
export class SuggestionEditComponent implements OnInit {
  ...
  imageFile: string = "";
  code: any;
  title = "เพิ่มข้อมูลข้อเสนอแนะ/ข้อแนะนำ";
  ...
  constructor(
    ...
    this.url = {
      create: this.apiProviderService.suggestion.create,
      read: this.apiProviderService.suggestion.read,
      update: this.apiProviderService.suggestion.update,
      delete: this.apiProviderService.suggestion.delete,
      category: {
        create: this.apiProviderService.suggestion.category.create,
        read: this.apiProviderService.suggestion.category.read,
        update: this.apiProviderService.suggestion.category.update,
        delete: this.apiProviderService.suggestion.category.delete,
      },
      gallery: {
        create: this.apiProviderService.suggestion.gallery.create,
        read: this.apiProviderService.suggestion.gallery.read,
        update: this.apiProviderService.suggestion.gallery.update,
        delete: this.apiProviderService.suggestion.gallery.delete,
      },
      galleryFile: {
        create: this.apiProviderService.suggestion.galleryFile.create,
        read: this.apiProviderService.suggestion.galleryFile.read,
        update: this.apiProviderService.suggestion.galleryFile.update,
        delete: this.apiProviderService.suggestion.galleryFile.delete,
      },
    };
  }

  ngOnInit(): void {
    this.permission = this.permissionService.readPermission("suggestionPage");
    this.permissionList =
      this.permissionService.readLocalStorage("suggestionPage");
    ...
    this.activetedRoute.queryParams.subscribe((params) => {
      ...
      if (this.code != "") {
        this.title = "แก้ไขข้อมูลข้อเสนอแนะ/ข้อแนะนำ";
        this.read();
      } else {
  ...
  galleryRead() {
    this.serviceProviderService
      .post("m/suggestion/gallery/read", { code: this.editModel.code })
      .subscribe(
        (data) => {
          let model: any = {};
          model = data;
  ...
  galleryFileRead() {
    this.serviceProviderService
      .post("m/suggestion/galleryFile/read", { code: this.editModel.code })
      .subscribe(
        (data) => {
          let model: any = {};
          model = data;
