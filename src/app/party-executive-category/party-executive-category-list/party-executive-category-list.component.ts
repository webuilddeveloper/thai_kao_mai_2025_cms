...
@Component({
  selector: 'app-party-executive-category-list',
  templateUrl: './party-executive-category-list.component.html',
  styleUrls: ['./party-executive-category-list.component.css']
})
export class PartyExecutiveCategoryListComponent implements OnInit {
  ...
  create() {
    this.router.navigate(['party-executive-category-edit', ''], { skipLocationChange: true });
  }

  view(param) {
    this.router.navigate(['party-executive-category-edit', param], { skipLocationChange: true });
  }
  ...
  delete(param, idx) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (result) {
        this.serviceProviderService.post('partyExecutive/category/delete', { code: param.code }).subscribe(data => {
  ...
  deleteAll() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (result) {
        ...
        this.serviceProviderService.post('partyExecutive/category/delete', { code: model }).subscribe(data => {
          this.toastr.success('ลบรายการเรียบร้อย', 'แจ้งเตือนระบบ', { timeOut: 2000 });
          setTimeout(() => {
