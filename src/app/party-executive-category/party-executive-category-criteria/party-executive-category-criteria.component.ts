...
@Component({
  selector: 'app-party-executive-category-criteria',
  templateUrl: './party-executive-category-criteria.component.html',
  styleUrls: ['./party-executive-category-criteria.component.css']
})
export class PartyExecutiveCategoryCriteriaComponent implements OnInit {
