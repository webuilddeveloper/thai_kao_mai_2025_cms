...
@Component({
  selector: 'app-party-executive-category',
  templateUrl: './party-executive-category.component.html',
  styleUrls: ['./party-executive-category.component.css']
})
export class PartyExecutiveCategoryComponent implements OnInit {
  model: any = [];
  listModel: string = '';
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('partyExecutiveCategoryPage') != null) {
      let model: any = [];
      model = JSON.parse(localStorage.getItem('partyExecutiveCategoryPage'));
