...
@Component({
  selector: 'app-suggestion-category-criteria',
  templateUrl: './suggestion-category-criteria.component.html',
  styleUrls: ['./suggestion-category-criteria.component.css']
})
export class SuggestionCategoryCriteriaComponent implements OnInit {
