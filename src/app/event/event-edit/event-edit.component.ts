...
export class EventEditComponent implements OnInit {
  ...
  imageFile: string = '';
  code: any;
  title = 'เพิ่มข้อมูลข่าวและกิจกรรม';
  ...
  ngOnInit(): void {
    this.permission = this.permissionService.readPermission("eventPage");
    this.permissionList = this.permissionService.readLocalStorage("eventPage");
    ...
    this.activetedRoute.queryParams.subscribe((params) => {
      ...
      if (this.code != "") {
        this.title = "แก้ไขข้อมูลปฏิทินกิจกรรม";
        this.read();
      } else {
        this.readCategory();
  ...
  readCategory() {
    this.serviceProviderService.post('m/eventCalendar/category/read', { permission: this.permission }).subscribe(data => {
      let model: any = {};
      model = data;
  ...
  deleteComment(param) {
    this.spinner.show()
    this.serviceProviderService.post('eventCalendar/comment/delete', param).subscribe(data => {
      let model: any = {};
      model = data;
  ...
  exportAsXLSX(): void {
    this.serviceProviderService.post('eventCalendar/comment/read', { skip: 0, limit: 999999, code: this.code }).subscribe(data => {
      let model: any = {};
      let result: any = [];
      model = data;
