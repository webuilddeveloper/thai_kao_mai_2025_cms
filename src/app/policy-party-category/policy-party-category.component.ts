...
@Component({
  selector: 'app-policy-party-category',
  templateUrl: './policy-party-category.component.html',
  styleUrls: ['./policy-party-category.component.css']
})
export class PolicyPartyCategoryComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('policyPartyCategoryPage') != null) {
      let model: any = [];
      model = JSON.parse(localStorage.getItem('policyPartyCategoryPage'));
