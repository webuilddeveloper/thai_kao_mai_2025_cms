...
@Component({
  selector: 'app-policy-party-category-edit',
  templateUrl: './policy-party-category-edit.component.html',
  styleUrls: ['./policy-party-category-edit.component.css']
})
export class PolicyPartyCategoryEditComponent implements OnInit {

  editModel: any = {};
      code: any;
      title = 'แก้ไขข้อมูลหมวดหมู่นโยบายพรรค';
      category: any;
      ...
      ngOnInit(): void {
        ...
        this.activetedRoute.queryParams.subscribe(params => {
          ...
          if (this.code != '') {
            this.title = 'แก้ไขข้อมูลหมวดหมู่นโยบายพรรค';
            this.read();
          }
        });
      ...
      create() {
        ...
        this.serviceProviderService.post('policyParty/category/create', this.editModel).subscribe(data => {
          let model: any = {};
          model = data;
          if (model.status === 'S') {
      ...
      read() {
        this.serviceProviderService.post('policyParty/category/read', { code: this.code, permission: 'all' }).subscribe(data => {
          let model: any = {};
          model = data;
      ...
      update() {
        ...
        if (this.editModel.image != undefined)
          this.editModel.imageUrl = this.editModel.image[0].imageUrl;
        this.serviceProviderService.post('policyParty/category/update', this.editModel).subscribe(data => {
          let model: any = {};
          model = data;
          if (model.status === 'S') {
            /** spinner ends after 5 seconds */
