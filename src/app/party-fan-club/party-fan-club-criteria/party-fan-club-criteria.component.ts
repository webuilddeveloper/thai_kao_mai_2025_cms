...
@Component({
  selector: 'app-party-fan-club-criteria',
  templateUrl: './party-fan-club-criteria.component.html',
  styleUrls: ['./party-fan-club-criteria.component.css']
})
export class PartyFanClubCriteriaComponent implements OnInit {
