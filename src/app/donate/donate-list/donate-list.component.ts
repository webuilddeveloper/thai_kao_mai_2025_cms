...
export class DonateListComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('donatePage') != null) {
      let model: any = [];
      this.permission = JSON.parse(localStorage.getItem('donatePage'));
  ...
  create() {
    this.router.navigate(['donate-details', ''], { skipLocationChange: true });
  }

  view(param) {
    this.router.navigate(['donate-details', param], { skipLocationChange: true });
  }
  ...
  delete(param, idx) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (result) {
        this.serviceProviderService.post('donate/delete', { code: param.code }).subscribe(data => {
  ...
  reOrder() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (result) {
        ...
        this.serviceProviderService.post('donate/reorder', { code: model }).subscribe(data => {
  ...
  reOrderAll() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (result) {
        this.serviceProviderService.post('donate/reorderAll', { code: model }).subscribe(data => {
          this.toastr.success('Re Order เรียบร้อย', 'แจ้งเตือนระบบ', { timeOut: 2000 });
          setTimeout(() => {
            window.location.reload()
          }, 2000)
  ...
  deleteAll() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (result) {
        ...
        this.serviceProviderService.post('donate/delete', { code: model }).subscribe(data => {
          this.toastr.success('ลบรายการเรียบร้อย', 'แจ้งเตือนระบบ', { timeOut: 2000 });
          setTimeout(() => {
            window.location.reload()
          }, 2000)
  ...
  exportAsXLSX(): void {
    ...
    this.serviceProviderService.post('donate/report/read', obj).subscribe(data => {
      let model: any = {};
      let result: any = [];
      model = data;
