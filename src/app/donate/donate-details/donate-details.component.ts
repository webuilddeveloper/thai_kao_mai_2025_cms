...
@Component({
  ...
  styleUrls: ['./donate-details.component.css']
})
export class DonateDetailsComponent implements OnInit {
  ...
  constructor(
    ...
    this.url = {
      create: this.apiProviderService.donate.create,
      read: this.apiProviderService.donate.read,
      delete: this.apiProviderService.donate.delete,
      category: {
        create: this.apiProviderService.donate.category.create,
        read: this.apiProviderService.donate.category.read,
        update: this.apiProviderService.donate.category.update,
        delete: this.apiProviderService.donate.category.delete,
      },
      gallery: {
        create: this.apiProviderService.donate.gallery.create,
        read: this.apiProviderService.donate.gallery.read,
        update: this.apiProviderService.donate.gallery.update,
        delete: this.apiProviderService.donate.gallery.delete,
      },
      galleryFile: {
        create: this.apiProviderService.donate.galleryFile.create,
        read: this.apiProviderService.donate.galleryFile.read,
        update: this.apiProviderService.donate.galleryFile.update,
        delete: this.apiProviderService.donate.galleryFile.delete,
      },
    };
  }

  ngOnInit(): void {
    this.permission = this.permissionService.readPermission("donatePage");
    this.permissionList = this.permissionService.readLocalStorage("donatePage");
    ...
    this.activetedRoute.queryParams.subscribe((params) => {
      ...
      if (this.code != "") {
        this.title = "รายละเอียดการบริจาค";
        this.read();
      } else {
  ...
  galleryRead() {
    this.serviceProviderService
      .post("m/donate/gallery/read", { code: this.editModel.code })
      .subscribe(
        (data) => {
          let model: any = {};
          model = data;
  ...
  galleryFileRead() {
    this.serviceProviderService
      .post("m/donate/galleryFile/read", { code: this.editModel.code })
      .subscribe(
        (data) => {
          let model: any = {};
          model = data;
  ...
  exportAsXLSX(): void {
    this.serviceProviderService
      .post("donate/comment/read", { skip: 0, limit: 999999, code: this.code })
      .subscribe(
        (data) => {
          let model: any = {};
          let result: any = [];
  ...
  back() {
    this.router.navigate(["donate"], { skipLocationChange: true });
  }
