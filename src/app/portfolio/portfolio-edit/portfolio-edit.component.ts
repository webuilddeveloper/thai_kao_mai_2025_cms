...
export class PortfolioEditComponent implements OnInit {
  ...
  Editor = ClassicEditor;
    ...
    constructor(private apiProviderService: ApiProviderService
      ...
      this.url = {
        create: this.apiProviderService.portfolio.create,
        read: this.apiProviderService.portfolio.read,
        update: this.apiProviderService.portfolio.update,
        delete: this.apiProviderService.portfolio.delete,
        category: {
          create: this.apiProviderService.portfolio.category.create,
          read: this.apiProviderService.portfolio.category.read,
          update: this.apiProviderService.portfolio.category.update,
          delete: this.apiProviderService.portfolio.category.delete
        },
        gallery: {
          create: this.apiProviderService.portfolio.gallery.create,
          read: this.apiProviderService.portfolio.gallery.read,
          update: this.apiProviderService.portfolio.gallery.update,
          delete: this.apiProviderService.portfolio.gallery.delete
        },
        galleryFile: {
          create: this.apiProviderService.portfolio.galleryFile.create,
          read: this.apiProviderService.portfolio.galleryFile.read,
          update: this.apiProviderService.portfolio.galleryFile.update,
          delete: this.apiProviderService.portfolio.galleryFile.delete
        }
      }
    ...
    ngOnInit(): void {
      this.permission = this.permissionService.readPermission('portfolioPage');
      this.permissionList = this.permissionService.readLocalStorage('portfolioPage');
    ...
    readCategory(param: string) {
      ...
      if (this.editModel.language != '') {
        this.serviceProviderService.post('portfolio/category/read', { language: param, permission: this.permission }).subscribe(data => {
          let model: any = {};
          model = data;
    ...
    galleryRead() {
      this.serviceProviderService.post('m/portfolio/gallery/read', { code: this.editModel.code }).subscribe(data => {
        let model: any = {};
        model = data;
    ...
    galleryFileRead() {
      this.serviceProviderService.post('m/portfolio/galleryFile/read', { code: this.editModel.code }).subscribe(data => {
        let model: any = {};
        model = data;
    ...
    exportAsXLSX(): void {
      this.serviceProviderService.post('portfolio/comment/read', { skip: 0, limit: 999999, code: this.code }).subscribe(data => {
        let model: any = {};
        let result: any = [];
        model = data;
    ...
    back() {
      this.router.navigate(['portfolio'], { skipLocationChange: true });
    }
